...
"background-color: rgba(255, 255, 255,0);psql -h localhost -p 5432 -U diva -d \"diva\""));
        ...
        R_label->setGeometry(QRect(1170, 220, 50, 40));
...
"background-color: rgba(255, 255, 255,0);psql -h localhost -p 5432 -U diva -d \"diva\""));
        ...
        N_label->setGeometry(QRect(1220, 220, 50, 40));
...
"background-color: rgba(255, 255, 255,0);psql -h localhost -p 5432 -U diva -d \"diva\""));
        ...
        D_label->setGeometry(QRect(1270, 220, 50, 40));
...
"background-color: rgba(255, 255, 255,0);psql -h localhost -p 5432 -U diva -d \"diva\""));
        ...
        label->setGeometry(QRect(1240, 260, 80, 80));
        ...
        label_2->setGeometry(QRect(1120, 260, 80, 80));
        ...
        total->setGeometry(QRect(1400, 100, 181, 32));
...
"color: rgb(98, 114, 164);"));
        ...
        gps_cb->setGeometry(QRect(1411, 257, 53, 23));
        gps_cb->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);"));
        gps_cb->setChecked(true);
        imu_cb = new QCheckBox(centralwidget);
        imu_cb->setObjectName(QString::fromUtf8("imu_cb"));
        imu_cb->setGeometry(QRect(1411, 292, 53, 23));
        imu_cb->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);"));
        imu_cb->setChecked(true);
        can_cb = new QCheckBox(centralwidget);
        can_cb->setObjectName(QString::fromUtf8("can_cb"));
        can_cb->setGeometry(QRect(1411, 327, 56, 23));
        can_cb->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);"));
        can_cb->setChecked(true);
        cam_cb = new QCheckBox(centralwidget);
        cam_cb->setObjectName(QString::fromUtf8("cam_cb"));
        cam_cb->setGeometry(QRect(1411, 362, 58, 23));
        cam_cb->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);"));
        cam_cb->setChecked(true);
        lidar_cb = new QCheckBox(centralwidget);
        lidar_cb->setObjectName(QString::fromUtf8("lidar_cb"));
        lidar_cb->setGeometry(QRect(1411, 397, 68, 23));
        lidar_cb->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);"));
